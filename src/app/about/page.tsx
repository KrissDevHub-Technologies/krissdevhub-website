    ...
    <>
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <span className="text-xs font-semibold uppercase tracking-widest text-white/40 mb-6 block">
              About us
            </span>
          </ScrollReveal>
          <TextReveal
      ...
      <section className="py-20 bg-[#0d0d0d] border-y border-white/[0.04]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              <div className="aspect-square rounded-3xl bg-[#121212] border border-white/[0.06] flex items-center justify-center">
                <div className="text-center p-8">
                  <div className="text-6xl mb-4 font-mono font-bold text-white">K</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {values.map((value, i) => (
              <ScrollReveal key={value.title} delay={i * 0.08}>
                <div className="p-6 rounded-2xl bg-[#121212] border border-white/[0.06] hover:border-white/[0.12] transition-all duration-300">
