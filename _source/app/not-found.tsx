  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          {/* 404 number */}
          <div className="text-[10rem] sm:text-[14rem] font-bold leading-none gradient-text opacity-20 select-none mb-4">
            404
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl glass border border-white/[0.1] text-sm font-medium text-white/70 hover:text-white transition-all"
            >
