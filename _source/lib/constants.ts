...
export const navLinks = [
  {
    ...
    href: "/services",
    children: [
      { label: "AI Development", href: "/services/ai-development", description: "LLM integrations, RAG systems, AI agents" },
      { label: "SaaS Development", href: "/services/saas-development", description: "End-to-end SaaS product engineering" },
      { label: "Custom Software", href: "/services/custom-software", description: "Bespoke software for complex problems" },
      { label: "API Integrations", href: "/services/api-integrations", description: "Connect any systems, any scale" },
      { label: "Automation", href: "/services/automation", description: "Intelligent workflow automation" },
    ],
  },
